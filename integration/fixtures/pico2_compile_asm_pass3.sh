...
tcheck --exth /sd/sb.th --exth /sd/sr.th --exth /sd/sl.th --exth /sd/ac.th --tgth /sd/p3l.th --tgt /sd/p3l.ast --out /sd/p3l.tast
...
tcheck --exth /sd/sb.th --exth /sd/sr.th --exth /sd/sl.th --exth /sd/ac.th --exth /sd/p3l.th --tgth /sd/asm_pass3.th --tgt /sd/asm_pass3.ast --out /sd/asm_pass3.tast
codegen < /sd/asm_pass3.tast > /sd/asm_pass3.bc
bc2asm < /sd/asm_pass3.bc > /sd/asm_pass3.s

# ===== Phase 3: link =====
asm_pass1 /src/hdr_asm_pass3.s --idx-out /sd/hdr.idx --text-bin /sd/hdr.tx --rodata-bin /sd/hdr.ro --data-bin /sd/hdr.dt --reloc-out /sd/hdr.rl
...
asm_pass2 --add /sd/hdr.idx --add /sd/crt0.idx --add /sd/runtime.idx --add /sd/in_0.idx --add /sd/in_1.idx --add /sd/in_2.idx --add /sd/in_3.idx --add /sd/in_4.idx --add /sd/in_5.idx --add /sd/in_6.idx --lab-out /sd/asm_pass3.lab
