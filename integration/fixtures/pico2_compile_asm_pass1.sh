...
# ===== Phase 3: link =====
asm_pass1 /src/hdr_asm_pass1.s --idx-out /sd/hdr.idx --text-bin /sd/hdr.tx --rodata-bin /sd/hdr.ro --data-bin /sd/hdr.dt --reloc-out /sd/hdr.rl
...
asm_pass2 --add /sd/hdr.idx --add /sd/crt0.idx --add /sd/runtime.idx --add /sd/in_0.idx --add /sd/in_1.idx --add /sd/in_2.idx --add /sd/in_3.idx --add /sd/in_4.idx --add /sd/in_5.idx --lab-out /sd/asm_pass1.lab
