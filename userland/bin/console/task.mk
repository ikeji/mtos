...
# software scrolling, so the arena is sized to hold it with headroom. Text mode
# (-t, tn20k) needs no extra: the hw text_lcd engine reads the zenkaku font
# in place from the .incbin'd blob in SDRAM (no copy, no buffer).
