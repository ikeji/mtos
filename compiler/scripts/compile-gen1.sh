...
CODEGEN="$ROOT_DIR/compiler/build/gen1/codegen"
BC2ASM="$ROOT_DIR/compiler/build/gen1/bc2asm"
RISCV_CC="riscv64-unknown-elf-gcc"
RISCV_FLAGS="-march=rv32im -mabi=ilp32 -static -nostdlib -lgcc -Wl,-Ttext-segment=0x10000"
CRT0="$ROOT_DIR/compiler/bootstrap/crt0.s"
RUNTIME="$ROOT_DIR/compiler/bootstrap/runtime_syscall.c"
