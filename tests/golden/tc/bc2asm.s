...
emit_fn__U8Array__I32Array__I32Array__I32Array__I32Array__I32Array__i32__StringBuffer:
    # prologue: frame_size=176, params=8, locals=25, eval_depth=9
    addi sp, sp, -176
    sw   ra, 172(sp)
    sw   s0, 168(sp)
    addi s0, sp, 176
