...
is_builtin__U8Array__i32__i32:
    # prologue: frame_size=80, params=3, locals=12
    addi sp, sp, -80
    sw   ra, 76(sp)
    sw   s0, 72(sp)
    addi s0, sp, 80
