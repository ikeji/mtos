...
double_val__i32:
    ...
    addi sp, t0, 0
    ret
    # end of double_val__i32

    .globl double_val__u8
    .type  double_val__u8, @function
double_val__u8:
    # prologue: frame_size=32, params=1, locals=0, eval_depth=2
    addi sp, sp, -32
    sw   ra, 28(sp)
    ...
    addi sp, t0, 0
    ret
    # end of double_val__u8

    .globl main
    .type  main, @function
main:
    # prologue: frame_size=48, params=0, locals=4, eval_depth=3
    addi sp, sp, -48
    sw   ra, 44(sp)
    sw   s0, 40(sp)
    addi s0, sp, 48
