# Self-build /sd/a3.bin on pico2 (Gen2 → Gen3, byte-exact vs
...
#
# Output uses short names (a3.lab / a3.bin) because fatfs is 8.3-only
# and "asm_pass3.lab" (13 chars) exceeds fatfs_open's 12-char limit.
#
...
parse < /src/asm_pass3.tc > /sd/a3.ast
sigscan < /sd/a3.ast > /sd/a3.th
cat /sd/sb.th /sd/sr.th /sd/sl.th /sd/ac.th /sd/p3l.th > /sd/a3_imp.th
tcheck --exth /sd/a3_imp.th --tgth /sd/a3.th --tgt /sd/a3.ast --out /sd/a3.tast
codegen < /sd/a3.tast > /sd/a3.bc
bc2asm < /sd/a3.bc > /sd/a3.s
...
asm_pass1 /sd/a3.s --idx-out /sd/in_5.idx --text-bin /sd/in_5.tx --rodata-bin /sd/in_5.ro --data-bin /sd/in_5.dt --reloc-out /sd/in_5.rl
...
asm_pass2 --add /sd/prelude.idx --add /sd/in_0.idx --add /sd/in_1.idx --add /sd/in_2.idx --add /sd/in_3.idx --add /sd/in_4.idx --add /sd/in_5.idx --add /sd/in_6.idx --lab-out /sd/a3.lab
asm_pass3 --lab /sd/a3.lab --out /sd/a3.bin
md5sum /sd/a3.bin
