# asm_pass2 phase breakdown — runs the same /sd/full.s through three
...
asm_pass2 < /sd/full.s > /sd/lab.s.A
asm_pass2 /sd/full.s > /sd/lab.s.B
asm_pass2 /sd/full.s /sd/strip.s > /sd/lab.s.C
echo BENCH_DONE
