...
tcheck --exth /sd/sb.th --exth /sd/sr.th --exth /sd/sl.th --tgth /sd/bf.th --tgt /sd/bf.ast --out /sd/bf.tast
codegen < /sd/bf.tast > /sd/bf.bc
bc2asm < /sd/bf.bc > /sd/bf.s

# ===== Phase 3: link =====
asm_pass1 /src/hdr_bc2asm.s --idx-out /sd/hdr.idx --text-bin /sd/hdr.tx --rodata-bin /sd/hdr.ro --data-bin /sd/hdr.dt --reloc-out /sd/hdr.rl
...
asm_pass2 --add /sd/hdr.idx --add /sd/crt0.idx --add /sd/runtime.idx --add /sd/in_0.idx --add /sd/in_1.idx --add /sd/in_2.idx --add /sd/in_3.idx --add /sd/in_4.idx --lab-out /sd/bc2asm.lab
