...
# ===== Phase 3: link =====
cat /src/hdr_tcheck.s /src/task_crt0.s /sd/runtime.s > /sd/prelude.s
...
asm_pass2 --add /sd/prelude.idx --add /sd/in_0.idx --add /sd/in_1.idx --add /sd/in_2.idx --add /sd/in_3.idx --add /sd/in_4.idx --add /sd/in_5.idx --lab-out /sd/tcheck.lab
