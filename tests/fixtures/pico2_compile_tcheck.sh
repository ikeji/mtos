...
# Then tcheck itself → in_4, task_data.s → in_5.
#
...
# ===== Phase 3: link =====
asm_pass1 /src/hdr_tcheck.s --idx-out /sd/hdr.idx --text-bin /sd/hdr.tx --rodata-bin /sd/hdr.ro --data-bin /sd/hdr.dt --reloc-out /sd/hdr.rl
...
asm_pass1 /sd/tc.s --idx-out /sd/in_4.idx --text-bin /sd/in_4.tx --rodata-bin /sd/in_4.ro --data-bin /sd/in_4.dt --reloc-out /sd/in_4.rl
...
asm_pass2 --add /sd/hdr.idx --add /sd/crt0.idx --add /sd/runtime.idx --add /sd/in_0.idx --add /sd/in_1.idx --add /sd/in_2.idx --add /sd/in_3.idx --add /sd/in_4.idx --add /sd/in_5.idx --lab-out /sd/tcheck.lab
asm_pass3 --lab /sd/tcheck.lab --out /sd/tcheck.bin
