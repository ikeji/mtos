...
cat /sd/sb.th /sd/sr.th /sd/sl.th /sd/ac.th > /sd/t_imp.th
tcheck --exth /sd/t_imp.th --tgth /sd/t.th --tgt /sd/t.ast --out /sd/t.tast
...
asm_pass2 --lab /sd/t.lab --out /sd/ap2.bin
md5sum /sd/ap2.bin
