...
| tcheck    | 717 KB |  80 KB | **75〜251 KB** | typecheck から派生、per-top-level reset + per-fn strtab rollback + **per-fn kmalloc fntab** (#51, #63, #64 完了)。残り bottleneck は vm_run の 2581 nodes (3072-slot AstNode pool) のみ |
| codegen   | 303 KB |  50 KB | **80〜252 KB** | strtab を perm/ephemeral 2 cursor 化 + per-top-level rollback (#59 完了)。bcrun.tc::vm_run の AstNode pool が 252 KB の outlier、他は 80〜190 KB |
| bc2asm    | 1.4 MB |  35 KB | **120〜126 KB** | **per-function emission** + per-fn strtab rollback (#60 完了)。残りボトルネックは bcrun.tc::vm_run 用の 64 KB instrs 固定バッファ |
| asm-pass1 | (新規) |  45 KB | **434 KB** | asm から派生、label collector のみ。`.lab` を出力 (#56)。次は label table の per-name kmalloc 化と numlab table の縮小 |
| asm-pass2 | (新規) |  45 KB | **4.6 MB** | asm から派生、`.lab` を読んで encoder。stream emit がまだなので g_code 4 MB が支配的 (#56 完了時点)。次は g_code 廃止 |
...
#### 実測 (#64 完了後、compile-gen2.sh + qemu-riscv32 / km_dump_peak)

per-top-level pool reset + per-fn strtab rollback + per-fn kmalloc fntab
の 3 段階削減を入れた状態:

| 入力 | km peak | nc | sp | fn | vr | tast 行 |
|---|---:|---:|---:|---:|---:|---:|
| compiler/strlib.tc       |  **75 KB** |   58 |  2521 |  93 |  0 |   386 |
| compiler/ast_node.tc      |  79 KB |   77 |  3796 | 139 |  1 |  1428 |
| compiler/string_buffer.tc |  83 KB |  157 |  3407 |  99 |  0 |  1181 |
| compiler/source_reader.tc |  83 KB |  143 |  3847 | 117 |  0 |  1291 |
| compiler/runtime.tc       |  90 KB |  221 |  5508 | 159 | 11 |  5457 |
| compiler/extract_sigs.tc  | 106 KB |  449 |  8014 | 160 | 13 |  1910 |
| compiler/sigscan.tc       | 107 KB |  461 |  8305 | 164 | 14 |  2405 |
| compiler/typecheck.tc     | 116 KB |  540 | 14303 | 210 | 54 |  7733 |
| compiler/tcheck.tc        | 120 KB |  584 | 14836 | 222 | 52 |  9531 |
| compiler/codegen.tc       | 135 KB |  854 | 13309 | 173 | 34 |  6037 |
| compiler/parse.tc         | 150 KB | 1080 | 19462 | 165 | 67 | 13064 |
| compiler/bc2asm.tc        | 190 KB | 1657 | 21652 | 187 | 47 |  9204 |
| compiler/asm.tc           | 190 KB | 1696 | 21056 | 154 | 34 | 10369 |
| **compiler/bcrun.tc**     | **251 KB** | **2581** | 25109 | 143 | 71 |  9290 |
