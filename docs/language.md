...
```
I32Array(size: u32) -> I32Array       // 確保（size は u32）
delete(arr: I32Array)                  // 解放
len(arr: I32Array) -> i32             // 長さ
get(arr: I32Array, idx: i32) -> i32   // 要素取得
set(arr: I32Array, idx: i32, val: i32) // 要素設定
```
...
len(arr: StringArray) -> i32
get(arr: StringArray, idx: i32) -> String
set(arr: StringArray, idx: i32, val: String)
```
...
len(arr: PointArray) -> i32
get(arr: PointArray, idx: i32) -> Point
set(arr: PointArray, idx: i32, val: Point)
```
...
var arr: PointArray = PointArray(8u32);
set(arr, 0, Point(1, 2));
