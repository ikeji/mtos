...
pool_init:
    # prologue: frame_size=16, params=0, locals=0, eval_depth=0
    addi sp, sp, -16
    sw   ra, 12(sp)
    sw   s0, 8(sp)
    addi s0, sp, 16
...
__runtime_init__u32__u32__u32__u32__u32__u32__u32:
    # prologue: frame_size=80, params=7, locals=5, eval_depth=3
    addi sp, sp, -80
    sw   ra, 76(sp)
    sw   s0, 72(sp)
    addi s0, sp, 80
...
pool_alloc__i32:
    # prologue: frame_size=48, params=1, locals=5, eval_depth=3
    addi sp, sp, -48
    sw   ra, 44(sp)
    sw   s0, 40(sp)
    addi s0, sp, 48
...
delete__StringLiteral:
    # prologue: frame_size=16, params=1, locals=0, eval_depth=0
    addi sp, sp, -16
    sw   ra, 12(sp)
    sw   s0, 8(sp)
    addi s0, sp, 16
...
print_i32__i32:
    # prologue: frame_size=64, params=1, locals=6, eval_depth=4
    addi sp, sp, -64
    sw   ra, 60(sp)
    sw   s0, 56(sp)
    addi s0, sp, 64
...
append__String__String:
    # prologue: frame_size=48, params=2, locals=4, eval_depth=3
    addi sp, sp, -48
    sw   ra, 44(sp)
    sw   s0, 40(sp)
    addi s0, sp, 48
...
equals__String__String:
    # prologue: frame_size=48, params=2, locals=3, eval_depth=4
    addi sp, sp, -48
    sw   ra, 44(sp)
    sw   s0, 40(sp)
    addi s0, sp, 48
