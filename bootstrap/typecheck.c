...
static void collect_struct(TypeEnv *e, AstNode *node) {
    ...
    /* Constructor, getters, setters, array ops, and delete are NOT
       registered here — they come from synthetic fn AST nodes generated
       by the parser (see gen_struct_synthetic_fns) and are registered
       via collect_fn. */
}
